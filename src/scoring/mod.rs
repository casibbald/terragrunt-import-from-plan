...
pub use strategies::{AzureScoringStrategy, DefaultScoringStrategy, GoogleCloudScoringStrategy};
...
mod tests {
    ...
    fn test_google_cloud_schema_driven_scoring() {
        ...
        let repo_id_metadata =
            create_test_metadata(true, false, "string", Some("The repository ID"));
        ...
        let name_metadata =
            create_test_metadata(true, false, "string", Some("The repository name"));
        ...
        assert!(
            repo_id_score > 80.0,
            "repository_id should be high confidence"
        );
    ...
    fn test_resource_specific_overrides() {
        ...
        let storage_name_score =
            strategy.score_attribute_with_metadata("name", &name_metadata, "google_storage_bucket");
        ...
        assert!(
            storage_name_score > generic_name_score,
    ...
    fn test_top_candidates_with_metadata() {
        ...
        assert_eq!(
            top_candidates[0], "repository_id",
            "repository_id should be the top candidate for artifact registries"
        );
    ...
    fn test_backward_compatibility() {
        ...
        assert!(
            old_score > 80.0,
            "Backward compatibility should still provide good scoring"
        );
    }
}
